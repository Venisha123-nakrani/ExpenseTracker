...
{
    /// <inheritdoc />
    public partial class finalmerging : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecurringExpenses_Payments_PaymentModeID",
                        column: x => x.PaymentModeID,
                        principalTable: "Payments",
                        principalColumn: "PaymentModeID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserID", "Address", "BirthDate", "Country", "CreatedAt", "Email", "FullName", "ImagePath", "PasswordHash", "PasswordResetToken", "PhoneNumber", "TokenExpiryTime" },
                values: new object[,]
                {
                    { 1, null, null, null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@expense.com", "Admin User", null, "Admin@123", null, null, null },
                    { 2, null, null, null, new DateTime(2024, 1, 2, 12, 0, 0, 0, DateTimeKind.Unspecified), "johndoe@example.com", "John Doe", null, "User@123", null, null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringExpenses_PaymentModeID",
                table: "RecurringExpenses",
                column: "PaymentModeID");
